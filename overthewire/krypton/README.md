...
```
```
# Use to decode and find key (key length: 6): https://www.guballa.de/vigenere-solver
# Key: frekey
...
```
```
# Use to decode and find key (key length: 3-30): https://www.guballa.de/vigenere-solver
# Key: keylength

# Use key to decode the krypton6 cipher: https://www.boxentriq.com/code-breaking/vigenere-cipher
```
...
mkdir /tmp/<username>
echo hello this is a plaintext file > /tmp/<username>/plaintext
...
cat HINT1
>>> The 'random' generator has a limited number of bits, and is periodic. Entropy analysis and a good look at the bytes in a hex editor will help. There is a pattern!
