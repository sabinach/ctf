...
```
```
# Using Frequency Analysis and Running Caesar Cipher
...
cat HINT
>>> Frequency analysis will still work, but you need to analyse it by "keylength".  
>>> Analysis of cipher text at position 1, 6, 12, etc should reveal the 1st letter of the key, in this case. 
>>> Treat this as 6 different mono-alphabetic ciphers... Persistence and some good guesses are the key!
